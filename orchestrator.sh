...
cmd_help() {
    ...
    echo "    bash orchestrator.sh update servidores_federais"
    echo "    bash orchestrator.sh update transferegov comprasnet obras"
    echo ""
    echo "  NOTAS:"
    echo "    obras: filtrado por UF=AM automaticamente"
    echo "    comprasnet: download desde 2021, pode demorar horas (checkpoint ativo)"
    echo ""
